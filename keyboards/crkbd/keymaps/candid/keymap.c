...
#define LR_BSP LT(_RAISE,KC_BSPC)
#define LA_TAB LT(_ADJUST,KC_TAB)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------+------|  |------+------+------+-------+------+-------+--------|
                               KC_LGESC,LA_TAB,LL_SPC,   LR_BSP,KC_ENT,KC_RALT
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+-------+-------+-------+-------+------|  |------+------+------+------+------+------+------|
                                   KC_LGUI,KC_TAB,KC_SPC,  KC_BSPC,KC_TRNS,KC_TRNS
                                  //`--------------------'  `--------------------'
  ),
